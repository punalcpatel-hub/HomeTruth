...
export default function Home() {
  ...
  async function submitReview(e:FormEvent<HTMLFormElement>) {
    ...
    const {error} = await supabase.from('property_reviews').insert({
      ...
      noise_rating:Number(form.get('noise_rating')),
      maintenance_rating:Number(form.get('maintenance_rating')),
      build_quality_rating:Number(form.get('build_quality_rating')),
      parking_rating:Number(form.get('parking_rating')),
      hoa_rating:Number(form.get('hoa_rating')),
